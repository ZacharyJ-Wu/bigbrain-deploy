let AsyncLock,fs,jwt,AccessError,InputError;_29a‍.x([["save",()=>save],["reset",()=>reset],["userLock",()=>userLock],["gameLock",()=>gameLock],["sessionLock",()=>sessionLock],["getEmailFromAuthorization",()=>getEmailFromAuthorization],["login",()=>login],["logout",()=>logout],["register",()=>register],["assertOwnsGame",()=>assertOwnsGame],["getGamesFromAdmin",()=>getGamesFromAdmin],["updateGamesFromAdmin",()=>updateGamesFromAdmin],["startGame",()=>startGame],["advanceGame",()=>advanceGame],["endGame",()=>endGame],["mutateGame",()=>mutateGame],["sessionStatus",()=>sessionStatus],["assertOwnsSession",()=>assertOwnsSession],["sessionResults",()=>sessionResults],["playerJoin",()=>playerJoin],["hasStarted",()=>hasStarted],["getQuestion",()=>getQuestion],["getAnswers",()=>getAnswers],["submitAnswers",()=>submitAnswers],["getResults",()=>getResults]]);_29a‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_29a‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_29a‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_29a‍.w("./error",[["AccessError",["AccessError"],function(v){AccessError=v}],["InputError",["InputError"],function(v){InputError=v}]]);
...
***************************************************************/
  ...
  gameLock((resolve, reject) => {
    ...
    resolve(filteredGames);
       ...
       const updateGamesFromAdmin = ({ gamesArrayFromRequest, email }) =>
  gameLock((resolve, reject) => {
    try {
  ...
  sessionLock((resolve, reject) => {
    ...
    if (session.position === -1) {
      ...
      try {
       ...
       const submitAnswers = (playerId, answersFromRequest) =>
  sessionLock((resolve, reject) => {
